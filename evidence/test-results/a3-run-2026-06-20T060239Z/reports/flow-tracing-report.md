...
| 2 | service | `CustomerService.create_customer` | `app/services/customer_service.py:17` |
...
| 2 | service | `KycService.submit_kyc` | `app/services/kyc_service.py:29` |
| 3 | repository | `CustomerRepository.get_by_id` | `app/repositories/customer_repository.py:32` |
| 4 | database | `table:customers` | — |
...
| 2 | service | `KycService.get_kyc_status` | `app/services/kyc_service.py:71` |
| 3 | repository | `CustomerRepository.get_by_id` | `app/repositories/customer_repository.py:32` |
| 4 | database | `table:customers` | — |
...
| 2 | service | `StandaloneVerificationService.verify_pan` | `app/services/standalone_verification_service.py:21` |
| 3 | repository | `CustomerRepository.get_by_id` | `app/repositories/customer_repository.py:32` |
| 4 | database | `table:customers` | — |
